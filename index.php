...
<html>
<head>
	<title>Tiny Daily Task Management</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
	<meta name="viewport" content="width=device-width, initial-scale=1">
	
	<!-- TDTM CSS -->
	<link rel="stylesheet" type="text/css" href="clientSide/extjs/css/ext-all.css">
	<link rel="stylesheet" type="text/css" href="clientSide/resources/css/tdtm.css">
	<link rel="stylesheet" type="text/css" href="clientSide/resources/css/fullcalendar.css">
	<link rel="stylesheet" type="text/css" href="clientSide/resources/css/start/jquery-ui-1.10.3.min.css">
